            ...
            child:
              ...
              Row(children: [
                ...
                ((Get.find<SplashController>()
                    ...
                    : const SizedBox(),
                SizedBox(
                    width: orderDetails.itemDetails!.isStoreverifiedActive! &&
                            orderDetails.itemDetails!.isverifiedItem!
                        ? Dimensions.paddingSizeExtraSmall
                        : 0),
                orderDetails.itemDetails!.isStoreverifiedActive! &&
                        orderDetails.itemDetails!.isverifiedItem!
                    ? const CustomAssetImageWidget(Images.verifiedTag,
                        height: 13, width: 13)
                    : const SizedBox(),
              ]),
            ]),
